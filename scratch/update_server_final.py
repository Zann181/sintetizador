...
final_html_content = r"""    void serveHTML(int client_fd) {
...
<body>
    ...
    <script>
        ...
        const BUILTIN_PERFS = {
            'song-5m': {
                name: "Canción 5-Minutos (Progression)",
                duration: 300,
                description: "Progresión de 5 min: Empieza suave, suave, entra base rítmica, fase de relax contemplativa, subida intensa al clímax frenético, reposo/relax post-clímax y desvanecimiento final.",
                keyframes: [
                    { timePct: 0, params: { "/master/bpm": 125, "/master/accent": 0.25, "/master/swing": 10, "/master/groove": 0, "/master/nota": 36, "/kick/vol": 0.25, "/kick/dec": 0.12, "/bass/vol": 0.0, "/snare/vol": 0.0, "/hat/vol": 0.0, "/syn1/vol": 0.0, "/syn2/vol": 0.0 } },
                    { timePct: 15, params: { "/master/bpm": 125, "/kick/vol": 0.75, "/kick/dec": 0.25, "/bass/vol": 0.35, "/bass/intervalo": -12, "/hat/vol": 0.3, "/hat/dec": 0.08 } },
                    { timePct: 35, params: { "/master/bpm": 130, "/master/accent": 0.65, "/master/groove": 3, "/kick/vol": 0.85, "/snare/vol": 0.6, "/hat/vol": 0.6, "/hat/dec": 0.15, "/bass/vol": 0.5, "/syn1/vol": 0.2, "/syn2/vol": 0.05 } },
                    { timePct: 55, params: { "/master/bpm": 130, "/kick/vol": 0.15, "/snare/vol": 0.0, "/hat/vol": 0.35, "/hat/dec": 0.45, "/bass/vol": 0.15, "/syn1/vol": 0.75, "/syn1/dec": 0.85, "/syn2/vol": 0.35, "/syn2/dec": 0.75 } },
                    { timePct: 75, params: { "/master/bpm": 140, "/master/accent": 0.95, "/master/swing": 35, "/master/groove": 6, "/kick/vol": 0.98, "/kick/comp_drive": 6.5, "/kick/dec": 0.3, "/bass/vol": 0.85, "/bass/drive": 0.8, "/snare/vol": 0.85, "/hat/vol": 0.85, "/hat/dec": 0.25, "/syn1/vol": 0.8, "/syn1/auto_p": 0.85, "/syn2/vol": 0.45, "/syn2/disp": 0.75 } },
                    { timePct: 90, params: { "/master/bpm": 128, "/master/accent": 0.55, "/master/swing": 15, "/master/groove": 1, "/kick/vol": 0.65, "/kick/comp_drive": 3.0, "/bass/vol": 0.45, "/snare/vol": 0.35, "/hat/vol": 0.45, "/syn1/vol": 0.35, "/syn2/vol": 0.15 } },
                    { timePct: 100, params: { "/kick/vol": 0.0, "/bass/vol": 0.0, "/snare/vol": 0.0, "/hat/vol": 0.0, "/syn1/vol": 0.0, "/syn2/vol": 0.0 } }
                ]
            },
            'house': {
                name: "House Automático",
                duration: 120,
                description: "Ritmo bailable característico del clásico House. BPM moderado, Groove unificado, faders moviéndose con MPC Swing (55%) y modulación de platillos envolventes.",
                keyframes: [
                    { timePct: 0, params: { "/master/bpm": 122, "/master/accent": 0.6, "/master/swing": 45, "/master/groove": 4, "/kick/vol": 0.8, "/bass/vol": 0.0, "/hat/vol": 0.2, "/snare/vol": 0.0 } },
                    { timePct: 25, params: { "/bass/vol": 0.65, "/bass/intervalo": -5, "/hat/vol": 0.6, "/hat/dec": 0.2 } },
                    { timePct: 50, params: { "/master/swing": 55, "/snare/vol": 0.7, "/syn1/vol": 0.45, "/syn2/vol": 0.1 } },
                    { timePct: 85, params: { "/kick/vol": 0.85, "/bass/vol": 0.7, "/hat/vol": 0.7, "/syn1/vol": 0.3, "/syn2/vol": 0.2 } },
                    { timePct: 100, params: { "/kick/vol": 0.0, "/bass/vol": 0.0, "/snare/vol": 0.0, "/hat/vol": 0.0, "/syn1/vol": 0.0, "/syn2/vol": 0.0 } }
                ]
            },
            'groove': {
                name: "Techno Groove",
                duration: 150,
                description: "Progresión centrada en el dinamismo percusivo y rolls. Modulación enérgica de los multiplicadores de reloj y transitorios de bombo para un ritmo sumamente tribal.",
                keyframes: [
                    { timePct: 0, params: { "/master/bpm": 133, "/master/accent": 0.7, "/master/swing": 12, "/master/groove": 5, "/kick/vol": 0.85, "/kick/reloj": 1.0, "/snare/vol": 0.0, "/hat/vol": 0.4 } },
                    { timePct: 30, params: { "/snare/vol": 0.65, "/snare/reloj": 1.0, "/kick/reloj": 2.0, "/master/swing": 25 } },
                    { timePct: 60, params: { "/kick/reloj": 1.0, "/hat/reloj": 2.0, "/bass/vol": 0.55, "/syn1/vol": 0.3 } },
                    { timePct: 85, params: { "/master/bpm": 136, "/kick/sweep": 250, "/snare/reloj": 2.0, "/master/swing": 45, "/syn2/vol": 0.25 } },
                    { timePct: 100, params: { "/kick/vol": 0.0, "/bass/vol": 0.0, "/snare/vol": 0.0, "/hat/vol": 0.0, "/syn1/vol": 0.0, "/syn2/vol": 0.0 } }
                ]
            },
            'hypnotic': {
                name: "Hipnótico Evolving",
                duration: 180,
                description: "Paisaje sonoro psicodélico y trippy. Los sintetizadores auto-modulan sus LFOs, filtros FDN y pesos continuamente para crear una inmersión tridimensional evolutiva.",
                keyframes: [
                    { timePct: 0, params: { "/master/bpm": 126, "/master/accent": 0.5, "/master/swing": 8, "/master/groove": 2, "/kick/vol": 0.6, "/bass/vol": 0.3, "/syn1/vol": 0.4, "/syn1/auto_v": 0.2, "/syn1/auto_p": 0.3, "/syn2/vol": 0.2, "/syn2/disp": 0.4 } },
                    { timePct: 35, params: { "/syn1/vol": 0.75, "/syn1/auto_v": 1.8, "/syn1/auto_p": 0.85, "/syn2/disp": 0.8, "/syn2/lfo_f": 4.5 } },
                    { timePct: 70, params: { "/kick/vol": 0.7, "/syn1/vol": 0.5, "/syn1/auto_r": 8.0, "/syn2/vol": 0.4, "/syn2/lfo_p": 0.95 } },
                    { timePct: 100, params: { "/kick/vol": 0.0, "/bass/vol": 0.0, "/snare/vol": 0.0, "/hat/vol": 0.0, "/syn1/vol": 0.0, "/syn2/vol": 0.0 } }
                ]
            },
            'hard': {
                ...
                duration: 90,
                description: "Máxima energía peak-time techno. El tempo sube a 145 BPM, la saturación del compresor de bombo se exprime al 100% y los filtros superiores se abren por completo.",
                keyframes: [
                    { timePct: 0, params: { "/master/bpm": 138, "/master/accent": 0.8, "/master/swing": 20, "/master/groove": 6, "/kick/vol": 0.9, "/kick/comp_drive": 4.5, "/kick/comp_thresh": 0.2, "/bass/vol": 0.6, "/snare/vol": 0.5, "/hat/vol": 0.6 } },
                    { timePct: 40, params: { "/master/bpm": 142, "/kick/comp_drive": 6.5, "/bass/drive": 0.75, "/hat/drive": 0.8, "/syn1/vol": 0.5 } },
                    { timePct: 75, params: { "/master/bpm": 145, "/master/accent": 0.98, "/kick/comp_drive": 8.0, "/bass/vol": 0.85, "/snare/vol": 0.85, "/syn2/vol": 0.4 } },
                    { timePct: 100, params: { "/kick/vol": 0.0, "/bass/vol": 0.0, "/snare/vol": 0.0, "/hat/vol": 0.0, "/syn1/vol": 0.0, "/syn2/vol": 0.0 } }
                ]
            }
        };
        ...
        function initPerformer() {
            try {
                const stored = localStorage.getItem('tr808_custom_perf');
                if (stored) {
                    customPerfPresets = JSON.parse(stored);
                }
        ...
        function saveActivePerformance() {
            ...
            try {
                ...
                localStorage.setItem('tr808_custom_perf', JSON.stringify(customPerfPresets));
                refreshPerformanceSelector();
                loadSelectedPerformance(activePerfKey);
                alert("Performance guardada con éxito en tu almacén local.");
            } catch(e) {
        ...
        function deleteActivePerformance() {
            const isCustom = !BUILTIN_PERFS[activePerfKey];
            if (!isCustom) return;
                    ...
                    ${INSTRUMENTS.map(inst => {
                        ...
                        return `
                            <div class="mixer-channel-strip ${activeStripClass}" id="chan-${inst.key}">
                                <div class="chan-title-row" onclick="setActiveInstrument('${inst.key}')" style="cursor:pointer;" title="Ver Síntesis Avanzada de ${inst.name.toUpperCase()}">
...
# Locate serveHTML block and replace it
...
content = content[:start_idx] + final_html_content + "\n    " + content[end_idx:]

with open(file_path, "w", encoding="utf-8") as f:
    f.write(content)

print("OscServer.cpp with click titles and active highlights updated successfully!")
