...
performer_html_content = r"""    void serveHTML(int client_fd) {
...
content = content[:start_idx] + performer_html_content + "\n    " + content[end_idx:]

with open(file_path, "w", encoding="utf-8") as f:
    f.write(content)

print("OscServer.cpp with Performer engine and clickable IP links updated successfully!")
